...
def get_nhist(df, query, kin, bin_range, nbins=20):
...
def plot_chisq(bin_centers, hist1, hist2, ax):
    ...
    text(0.24, 0.95,'$$\chi^2/d.o.f. = %.02f$$' % chisq_pdf,
...
def plt_kin_ax(df, kin, targetPos, target, ax, roadset1, roadset2, chisq):
    ...
    if roadset2['label'] in ('R67', 'R70'):
        ...
        if kin in ('pz2','pt2'):
            ...
            list_kin[2]='1'
            kin = "".join(list_kin)
    hist1, bin_centers = get_nhist(df, query1, kin, kin_range, nbins=nbins)
    ...
    if roadset2['label'] in ('R67', 'R70'):
        ...
        if kin in ('pz2','pt2'):
            ...
            list_kin[2]='1'
            kin = "".join(list_kin)
    hist2, bin_centers = get_nhist(df, query2, kin, kin_range, nbins=nbins)
...
def plt_kin(df, kin, axis_label, roadset1, roadset2, chisq=True):
